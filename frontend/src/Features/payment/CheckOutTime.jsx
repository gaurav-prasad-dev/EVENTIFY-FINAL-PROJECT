    ...
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      {showExpiredModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-[340px] text-center shadow-xl">
            ...
            <button
              onClick={() => navigate("/")}
              className="bg-black text-white px-4 py-2.5 rounded-xl w-full cursor-pointer hover:bg-gray-800 transition font-medium"
            >
              Book Again
            </button>
          </div>
      ...
      {/* TIMER BAR */}
      <div className="bg-purple-100 text-center py-2.5 px-4 text-xs sm:text-sm font-medium">
